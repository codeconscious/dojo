...
namespace CSharp
{
    // SOURCE: https://dotnetfiddle.net/9tTt5us
    public static class AwaitExample
    {
        ...
        {
            WriteLine("Entering AsyncMethodB.");
            WriteLine("   Expected '{0}', AsyncLocal value is '{1}', ThreadLocal value is '{2}'",
                            expectedValue, _asyncLocalString.Value, _threadLocalString.Value);
            await Task.Delay(100);
            WriteLine("Exiting AsyncMethodB.");
            WriteLine("   Expected '{0}', got '{1}', ThreadLocal value is '{2}'",
                            expectedValue, _asyncLocalString.Value, _threadLocalString.Value);
        }
        ...
        {
            AsyncMethodA().GetAwaiter().GetResult();
        }
    }
